...
def start():
    ...
    # ตั้งให้รัน Sync ทุกๆ 20 วินาที (ปรับเปลี่ยนได้ตามความเหมาะสม)
    scheduler.add_job(sync_jobs_from_mssql, 'interval', seconds=20, id='sync_mssql_job', replace_existing=True)
